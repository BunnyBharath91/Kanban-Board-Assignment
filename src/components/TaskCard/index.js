...
const TaskCard = (props) => {
  const { type, itemDetails } = props;
  const { id, priority, status, tag, title, userName } = itemDetails;
    ...
    <div className="card">
      <div className="card-main-container">
        ...
        <div className="card-middle-container">
          {type !== "status" && groups.status[statusSymbol]}
          <h1 className="task">{title}</h1>
        </div>

        <div className="card-lower-container">
          <div className="feature-request-status-card">
            {type !== "priority" && groups.priority[prioritySymbol]}
          </div>

          {tag.map((eachItem) => (
            <div className="feature-request">
              <div className="feature-request-symbol"></div>
              <span>{eachItem}</span>
            </div>
          ))}
        </div>
      ...
      <div className="profile-container">
        <img
          alt="profile-img"
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT4CAb2Hq3Bz_rGytGSc91bxNwXTLFqD8WLSw&s"
